...
interface SelectedItemButtonProps {
  selectedIteam: string;  
  handleDeleteSelected: (item: string) => void; 
}

const SelectedIteamButton: React.FC<SelectedItemButtonProps> = ({ selectedIteam, handleDeleteSelected }) => {
  return (
